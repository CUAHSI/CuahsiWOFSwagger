        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration 
                .EnableSwagger(c =>
                    ...
                    .License(lc => lc
                    .Name("CUAHSI Water Data Services Data Use Agreement")
                    .Url("http://his.cuahsi.org/documents/Data%20Policies%20Draftv2.pdf"));
                        ...
                        c.IncludeXmlComments(String.Format(@"{0}\Wb.XML", AppDomain.CurrentDomain.BaseDirectory));
